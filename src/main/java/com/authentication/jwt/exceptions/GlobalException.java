package com.authentication.jwt.exceptions;
...
public class GlobalException {
    ...
    public ProblemDetail handleSecurityException(Exception exception) {
        ...
        if (exception instanceof BadCredentialsException) {
            ...
            errorDetail.setProperty("description", "O nome de usuário ou a senha estão incorretos");
            return errorDetail;
        }
        ...
        if (errorDetail == null) {
            ...
            errorDetail.setProperty("description", "Erro interno desconhecido no servidor.");
        }
